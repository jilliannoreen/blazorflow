...
public partial class Button
{
    ...
    private string GetVariantColorClass()
    {
        var map = new Dictionary<(Color, Variant), string>
        {
            ...
            { (Color.Light, Variant.Text), "text-white bg-transparent" },
            
            // Inherit
            { (Color.Inherit, Variant.Filled), "text-inherit bg-inherit hover:bg-inherit" },
            { (Color.Inherit, Variant.Outlined), "text-inherit border border-inherit bg-transparent hover:bg-inherit" },
            { (Color.Inherit, Variant.Text), "text-inherit bg-transparent hover:text-inherit" },
        };
